...
#
# NOTE: Factory design_1.bd stores PSU__CRF_APB__DDR_CTRL__FREQMHZ=1200.
# Vivado 2020.1 batch validation rejects that range (max 800). We clamp to 600
# here for scripted BD creation; for production boot, re-import PS config from
# the factory board_test project GUI (or apply DDR4 speed-bin so Vivado
# recalculates). See scripts/create_bd.tcl header.
...
# Instance in source BD: zynq_ultra_ps_e_0
# CONFIG property count: 1013

proc apply_ps_preset {cell} {
  if {$cell eq ""} {
    error "apply_ps_preset: cell is empty"
  }
  ...
  set_property -dict [list \
    ...
    CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash########SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#I2C 1#I2C 1#GPIO1 MIO#DPAUX#DPAUX#DPAUX#DPAUX#USB0 Reset#CAN 1#CAN 1#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#PCIE#CAN 0#CAN 0#GPIO1 MIO#GPIO1 MIO#UART 0#UART 0#GPIO1 MIO#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3} \
